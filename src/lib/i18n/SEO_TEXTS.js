...
export const excursions_SEO_TEXT = {
    ru: {
...
export const transfers_SEO_TEXT = {
    ru: {
...
export const about_SEO_TEXT = {
    ...
    en: {
        ...
        keywords: "about us, Kemer, excursions, rental, transfers, guides",
        twitter:
    ...
    tr: {
        ...
        keywords: "hakkımızda, Kemer, turlar, kiralama, transfer, rehberler",
