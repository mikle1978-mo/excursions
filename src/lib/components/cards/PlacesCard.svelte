...
<div class="card">
    ...
    >
        ...
        {#if getLabelByKey(item.meta.labels, "POPULAR")}
            <span class="card__badge topright">
                {getLabelByKey(item.meta.labels, "POPULAR").label[$locale]}
            </span>
        {/if}
        {#if getLabelByKey(item.meta.labels, "NEW")}
            <span class="card__badge topleft">
                {getLabelByKey(item.meta.labels, "NEW").label[$locale]}
            </span>
        {/if}
        {#if getLabelByKey(item.meta.labels, "VIP")}
