export const main_page = {
	...
	main_text: {
		ru: `<p>
			...
			<p>
				У нас за плечами — тонны насмотренности, страсть к инновациям и желание удивлять. 
				Мы верим, что лучшее время для игр — это сейчас, и готовы доказать это вам.
			</p>
			<p>
		...
		en: `<p>Welcome to TapTap Studio — where the future of the gaming industry is born!</p>
        	<p>
            	...
            	simpler, and more exciting. With every game, we challenge the ordinary and open the door to 
            	something entirely new.
        	</p>
        	<p>
            	We bring a wealth of experience, a passion for innovation, and a desire to amaze. 
            	We believe that there's no better time to play than now, and we're ready to prove it to you.
        	</p>
        	<p>
